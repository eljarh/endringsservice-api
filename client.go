...
// APIClient manages communication with the Endringsservice API v1.0.0
...
type APIClient struct {
	...
	ProduksjonsplassApi *ProduksjonsplassApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ProduksjonsplassApi = (*ProduksjonsplassApiService)(&c.common)
